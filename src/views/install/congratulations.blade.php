    ...
    <div class=" bg-violet-50 min-h-screen">
        <div class="container mx-auto">
            <div class="2xl:flex xl:flex lg:flex md:block 2xl:space-x-8 xl:space-x-8 lg:space-x-8 md:space-x-0 py-20 relative">
                ...
                <div class=" bg-white h-auto rounded-3xl w-full px-12 py-12 text-center">
                    ...
                    <div class=" mt-8 mb-5">
                        <a class=" border border-indigo-500 px-7 py-3 rounded-md text-gradient mr-3" href="{{ url('/') }}">{{ __('View Site') }}</a>
                        <a class="bg-gradient px-7 py-3-2 rounded-md text-white font-light" href="{{ url(config('installer.admin_login', '/admin/login')) }}">{{ __('Admin Login') }}</a>
                    </div>
                </div>
            </div>
        </div>
